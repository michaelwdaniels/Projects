...
load("saved_images/6C_boxplots_unbalanced_30")
# ---------------------------------------------------------------------------- #
...
png('results/plots/6C_seqFeatures_unbalanced_30.png',
...
png('results/plots/6C_seqFeatures_unbalanced_0_100_30.png',
    height = 8, width = 8, res = 300, units = 'in')
boxplot(tog$AUC~tog$method*tog$n,at=at,col=c('red','lightblue1','cadetblue3','dodgerblue2'),xlab='% Training Set', ylab='AUC',xaxt="n",
...
png('results/plots/6C_seqFeatures_unbalanced_paper_30.png',
    height = 8, width = 8, res = 300, units = 'in')
...
save.image("saved_images/6C_boxplots_unbalanced_30")
