load("saved_images/6D_boxplots_balanced_50")
# ---------------------------------------------------------------------------- #
...
png('results/plots/6D_allFeatures_balanced_50.png',
...
png('results/plots/6D_allFeatures_balanced_0_100_50.png',
    height = 8, width = 8, res = 300, units = 'in')
boxplot(tog$AUC~tog$method*tog$n,at=at,col=c('red','lightblue1','cadetblue3','dodgerblue2'),xlab='% Training Set', ylab='AUC',xaxt="n",
...
png('results/plots/6D_allFeatures_balanced_paper_50.png',
    height = 8, width = 8, res = 300, units = 'in')
...
save.image("saved_images/6D_boxplots_balanced_50")
