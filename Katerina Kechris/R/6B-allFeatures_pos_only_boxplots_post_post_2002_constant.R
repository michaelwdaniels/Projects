load("saved_images/6B_boxplots_constant")
# ---------------------------------------------------------------------------- #
# Script 6B
# Author: Mike Daniels
#
...
png('results/plots/6B-ROC_seqFeatures_pos_only_boxplots_post_post_2002_constant.png',
...
png('results/plots/6B-ROC_allFeatures_pos_only_boxplots_post_post_2002_constant_paper.png',
    height = 8, width = 8, res = 300, units = 'in')
...
save.image("saved_images/6B_boxplots_constant")
