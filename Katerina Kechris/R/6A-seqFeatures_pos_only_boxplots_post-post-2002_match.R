load("saved_images/6A_boxplots_match")
# ---------------------------------------------------------------------------- #
# Script 6A
# Author: Mike Daniels
#
...
png('results/plots/6A-ROC_seqFeatures_pos_only_boxplots_post_post_2002_match.png',
...
save.image("saved_images/6A_boxplots_match")
