load("saved_images/5A_boxplots_match_test")
# ---------------------------------------------------------------------------- #
# Script 5A
# Author: Mike Daniels
#
...
png('results/plots/5A-ROC_seqFeatures_pos_only_boxplots_pre_post_2002_match_test.png',
...
png('results/plots/5A-ROC_seqFeatures_pos_only_boxplots_pre_post_2002_match_test_paper.png',
    height = 8, width = 8, res = 300, units = 'in')
...
save.image("saved_images/5A_boxplots_match_test")
